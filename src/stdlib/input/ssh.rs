...
pub fn disabled_ssh_command(_context: NativeCallContext, _addr: String, _cmd: String) -> Result<Dynamic, Box<EvalAltResult>> {
    Err("TSAK is in sandbox mode. input::ssh() is disabled".into())
}
